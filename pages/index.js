...
class App extends Component {
  static async getInitialProps({ renderPage }) {
    ...
    console.log("Quick Link", quickLink.data);
    let service = await axios.get(API_ENDPOINT + '/homepage/service');
    console.log("Service", service.data);
    let job = await axios.get(API_ENDPOINT + '/homepage/job');
    console.log("Job", job.data);
    let announcement = await axios.get(API_ENDPOINT + '/homepage/announcement');
    console.log("announcement", announcement.data);
    let download = await axios.get(API_ENDPOINT + '/homepage/download');
    console.log("download", download.data);
    let portal = await axios.get(API_ENDPOINT + '/homepage/portal');
    console.log("portal", portal.data);
    let goods = await axios.get(API_ENDPOINT + '/homepage/goods');
    console.log("goods", goods.data);
    let event = await axios.get(API_ENDPOINT + '/homepage/event');
    console.log("event", event.data);
    return { heroes: hero.data, quickLink: quickLink.data, services: service.data, jobs: job.data, announcements: announcement.data, downloads: download.data, portals: portal.data, goods: goods.data, events: event.data }
  }
        ...
        <div className="theme-setting-wrapper">
          ...
          <div id="theme-settings" className="settings-panel"> <i className="settings-close fa fa-times" />
            ...
            <div className="page-layout">
              ...
              <div className="sidebar-bg-options">
                <a className href="pages/layout/boxed-layout.html">Boxed</a></div>
              <div className="sidebar-bg-options">
                <a className href="pages/layout/rtl-layout.html">RTL</a></div>
              <div className="sidebar-bg-options">
                  ...
                  {this.props.heroes.map((hero, i) => {
                    return (
                      <div className="slide" key={i}>
                        <img src={hero.image.url} className="slider-bg" />
                ...
                <div className="container">
                  <div className="row">
                    <div className="col col-lg-3 col-md-4">
                      ...
                      <p dangerouslySetInnerHTML={{__html: this.props.quickLink[0].content.brief}}/>
                      </div>
                              ...
                              <div className="grid" key={i}>
                                <div className="inner mk-bg-img">
                                  <div className="details ">
                                    <div className="info">
                                        <img src={service.image.url} className="bg-image" />
                                      <a href="#">
                                        <h3><i className="fa fa-angle-right" />{service.title}</h3>
                                      </a>
                                      <p>{service.content.brief}</p>
                          ...
                          return (
                            <div className="grid" key={i}>
                              <div className="inner mk-bg-img">
                                <div className="details ">
                                  <div className="info">
                                    <img src={announcement.image.url} className="bg-image" />
                                    <a href="#">
                                      <h3><i className="fa fa-angle-right" />{announcement.title}</h3>
                                    </a>
                                    <p>{announcement.content.brief}</p>
                                    <a href="#" className="more">Get Details</a>
                                  </div>
                                </div>
                              </div>
                          ...
                          {this.props.downloads.map((download, i) => {
                            ...
                            <li className="single-item" key={i}>
                              <div className="item-img">
                                  <a href="#"><img src={download.image.url} alt="Post" /></a>
                              </div>
                          ...
                          { this.props.portals.map((portal, i) => {
                              return (
                                <div className={"carousel-item" + (i==0?' active':'')} key={i}>
                                  <img className="d-block w-100" src={portal.image.url} alt="First slide" />
                      ...
                      <div className="widget-blog-post">
                        <ul className="block-list">
                          {this.props.goods.map((thing, i) => {
                            ...
                            <li className="single-item" key={i}>
                              <div className="item-img">
                                  <a href="#"><img src={thing.image.url} alt="Post" /></a>
                              </div>
                              <div className="item-content">
